...
export default function FieldTaskPage() {
  ...
  const load = useCallback(async () => {
    ...
    setTask(allowedTask as Task); setSteps((stepResult.data || []) as Step[]); setAttachments((attachmentResult.data || []) as Attachment[]); setMessage(''); setLoading(false);
  },[router,taskId]);
